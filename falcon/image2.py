...
“Falcon Agent：GPT-5.5 + Image2 驱动的自动化采集、分析、运营平台”

画面包含这些层级：
- 采集基座层：多平台真实浏览器采集，获取标题、正文、发布时间、互动指标、评论、媒体资产和证据。
- 数据分析层：内容表现分析、用户意向分析、评论需求分析、人工评分反哺。
- 报表工作台：本地 Web UI，展示采集队列、样本、洞察、质量校准和任务状态。
- 内容生成层：GPT-5.5 生成报告、选题、草稿和操作建议，Image2 生成辅助视觉资产。
- 推荐执行层：半自动预览，用户可修改或确认后执行。
- 通知与人工处理层：验证码、风控暂停、账号确认、任务通知。
