...
Falcon Agent 是一个独立的自动化采集、分析和运营平台。它不是导入工具，也不是外部自动化流程的包装层，而是一套本地智能体工作台。

Falcon 负责采集公开平台信号、沉淀文本和媒体资产、分析需求与内容结构、生成报告和运营建议，并把可执行动作放入人工确认队列。
...
- 分析：规则 + GPT-5.5。
- 生成：GPT-5.5 报告、选题和草稿，Image2 辅助视觉资产。
...
生成评论草稿、私信草稿、发帖标题、正文、选题说明、运营建议和视觉提示。
